...
// I see no real advantage in using useForm when posting to local json using action prop, as error handeling only gets triggered when onSubmit is called.
	...
	return (
		<div>
			...
			<div className='contactForm'>
				...
				<form className='[ formGrid ]' action={ADD_MESSAGE} method='post' onFocus={handleSubmit()} >
